...
export default function RegisterFromCompany({ companyCode }) {
    ...
    const { login, alert, theme, colorPalette, setLoading, isAuthenticated } = useAppContext()
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{ display: { xs: 'none', xm: 'none', md: 'flex', lg: 'flex' }, gap: 2, flexDirection: 'column', maxWidth: 480, marginBottom: 20, padding: '20px' }}>
                                ...
                                <Text large light style={{ color: '#fff' }}>Bem-vindo! Estamos feliz em ter você conosco. A Afectu nasceu para oferecer o suporte que você precisa no enfrentamento dos seus desafios emocionais!</Text>
                            </Box>
                            ...
                            <Box sx={{
                                ...
                                minHeight: 800,
                                alignItems: 'center',
                                padding: { xs: '20px 30px', xm: '20px 30px', md: '20px 30px', lg: '30px 15px' },
                                backgroundColor: '#fff',
                                gap: 3,
                            }}>
                                ...
                                <form style={{ display: 'flex', flexDirection: 'column', gap: 3, alignItems: 'center', width: '100%', }}>
                                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, alignItems: 'center', width: '100%', }}>
                                        ...
                                        <Box sx={{
                                            display: 'flex', flexDirection: 'column', gap: 2, width: { xs: `100%`, xm: `100%`, md: '100%', lg: '80%' }, justifyContent: 'center',
                                        }}>
