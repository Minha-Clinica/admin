   ...
   return (
      <>
         <Head>
            ...
            <meta charset="utf-8" />
            <link rel="icon" href="https://mf-planejados.s3.amazonaws.com/tec_icon_dark.png" />
         </Head>
         <Box sx={{ display: 'flex', gap: 1, flexDirection: 'row' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', width: { xs: '100%', xm: '100%', md: '100%', lg: '100%' }, transition: '0.5s', marginTop: 10, padding: '10px 50px' }}>
               <Box>
                  ...
                  <Box sx={{ display: 'flex', gap: 2, padding: '20px 0px', flexDirection: 'column' }}>
                     <Box sx={{ display: 'flex', gap: 2 }}>

                        <ContentContainer fullWidth>
                           <Box>
                              <Text bold style={{fontSize: 30}}>350</Text>
                              <Text>
                                 Alunos Matrículados
                              </Text>
                           </Box>
                        ...
                        <ContentContainer fullWidth>
                           <Box>
                              <Text bold style={{fontSize: 30}}>150</Text>
                              <Text>
                                 Alunos Pendente de Re-matrícula
                              </Text>
                           </Box>
                        </ContentContainer>
                        ...
                        <ContentContainer fullWidth>
                           <Box>
                              <Text bold style={{fontSize: 30}}>25</Text>
                              <Text>
                                 Cursos Cadastrados
                              </Text>
                           </Box>
                        ...
                        <ContentContainer fullWidth>
                           <Box>
                              <Text bold style={{fontSize: 30}}>60</Text>
                              <Text>
                                 Turmas Cadastradas
                              </Text>
                           </Box>
                     ...
                     <Box sx={{ display: 'flex', gap: 2, }}>
                        <ContentContainer fullWidth>
                           <Box>
                              <Text bold large style={{ textAlign: 'center' }}>Eventos do mês {moment(defaultYear?.start).format('MMMM YYYY')}</Text>
